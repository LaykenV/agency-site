      ...
      <section className="flex flex-col gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--secondary)]">
            Pick the path that matches your momentum. Checkout is coming soon, but you can preselect a tier now.
          </p>
        </div>
        <PlanSummaryInline plan={plan} onCheckout={onCheckout} />
      </section>
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-5 rounded-3xl border border-[var(--border)] bg-[var(--background)]/60 p-6">
      ...
      <button
        ...
        className="inline-flex items-center justify-center rounded-full bg-[var(--foreground)] px-6 py-3 text-sm font-semibold text-[var(--background)] transition hover:opacity-90"
      >
        Checkout – {headline}
      </button>
    </div>
