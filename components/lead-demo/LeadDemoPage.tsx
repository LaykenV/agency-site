...
export function LeadDemoPage({ demo }: LeadDemoPageProps) {
  ...
  const scoreAnimates = Number.isFinite(scoreValue) && demo.recommendation.score.endsWith("%");
    ...
    <div className={styles.page}>
      <aside className={styles.conceptBar} aria-label="Website concept notice">
        ...
        <Link className={styles.conceptBarLink} href="/onboarding">
          Want this live? $199/mo, no setup fee
        </Link>
      </aside>
      ...
      <main id="top">
        <section className={styles.statHero}>
          ...
          <h1 className={styles.statTitle}>
              ...
              {scoreAnimates ? (
                <>
                  <span
                    ...
                    style={{ "--lead-stat-target": scoreValue } as CSSProperties}
                  />
            ...
            <span className={styles.srOnly}>
              {demo.recommendation.score} of reviewers recommend {demo.businessName}.
            </span>
          </h1>
          <p className={styles.qualifier}>
            ...
            recommend {demo.businessName} — {demo.recommendation.count} so far.
          </p>
          <div className={styles.heroActions}>
            <a className={`${styles.chip} ${styles.chipPrimary}`} href={demo.phoneHref}>
              <Phone aria-hidden="true" size={17} strokeWidth={1.8} />
        ...
        >
          ...
          <p className={styles.sectionSub}>
            Call or text with the space you have in mind and ask for a free quote.
          </p>
        ...
        <aside className={styles.awdBand} aria-label="Offer from Acadiana Web Design">
          <div className={styles.awdInner}>
            <p className={styles.awdKicker}>Prepared by Acadiana Web Design</p>
            <p className={styles.awdOffer}>Want this live? $199/mo, no setup fee.</p>
            <p className={styles.awdDetail}>
              $0 down — hosting, domain, unlimited edits, and support included. Launch-ready
              in days, not months.
            </p>
      ...
      <footer className={styles.footer}>
        ...
        <p className={styles.previewNote}>
          Concept preview only — not the business’s live website. Content and service details
          would be confirmed with the owner before launch.
        </p>
      </footer>
    </div>
  );
